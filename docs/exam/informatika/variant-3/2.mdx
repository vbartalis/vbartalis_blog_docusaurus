  ...
  <div>
    <Tabs>
      ...
      <TabItem value="2" label="Előírt lépésszámú ciklus" default>
        ...
        A ciklusváltozó a tartománynak vagy minden elemét felveheti (beleértve a
        kezdő- és végértéket is), vagy csak a tartományban szabályosan (ekvidisztánsan)
        elhelyezkedő bizonyos értékeket. Ekkor meg kell adni a tartományban a felvehető
        elemek távolságát meghatározó <b>lépésközt</b>. A változó az adott tartományt
        befuthatja növekvőleg, illetve csökkenőleg, ezt határozza meg az <b>
          irány
        </b>.
      </TabItem>
